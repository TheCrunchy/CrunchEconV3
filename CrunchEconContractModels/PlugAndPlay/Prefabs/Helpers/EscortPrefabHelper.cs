...
{
    public class EscortPrefabHelper : PrefabsHelperAbstract
    {
        public override void Init()
        {
            ...
            ReflectPrefabs(definitionType, definition, "Sandbox.Definitions.MyContractTypeEscortDefinition", "PrefabsEscortShips");
        }
    }
}
