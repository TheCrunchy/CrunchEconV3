...
namespace CoreSystems.Api
{
    ...
    public partial class WcApi
    {
        ...
        public class DamageHandlerHelper
        {
            ...
            {
                //Core.Log.Info("Damage handler");
                //foreach (var item in list)
                //{
                //    var targetParent = item.WeaponEntity.Parent;
                //    if (targetParent is MyCubeGrid grid)
                //    {
                //        if (grid.GridGeneralDamageModifier?.Value == 0.5f)
                //        {
                //            Core.Log.Info("Grid has a damage modifier");
                //        }
                //    }
                //}
                // Your code goes here
